...
import News from '@material-ui/icons/Favorite';
...
class PrimarySearchAppBar extends React.Component {
  ...
  render(){
    ...
    const renderMenu = (
      ...
      >
        <MenuItem onClick={this.handleMenuClose}>Моя страница</MenuItem>
        <MenuItem onClick={() => {handleMenuClose(); userLogout()}}>Выйти</MenuItem>
      </Menu>
    );
